...
ActiveRecord::Schema.define(:version => 20100527164143) do
  ...
  create_table "product_vendors", :force => true do |t|
    t.integer "product_id"
    t.string  "id_by_vendor"
  end

  add_index "product_vendors", ["id_by_vendor"], :name => "index_product_vendors_on_id_by_vendor"
